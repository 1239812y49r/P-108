        ...
        for hand_landmark in results.multi_hand_landmarks:
            ...
            if all(finger_fold_status):
                ...
                if lm_list[thumb_tip].y < lm_list[thumb_tip-1].y < lm_list[thumb_tip-2].y:
                    print("me gusta")  
                    cv2.putText(img ,"es hermoso haz mas de estos", (20,30), cv2.FONT_HERSHEY_SIMPLEX, 1, (0,255,0), 3)

                # Verificar si el pulgar está abajo
                if lm_list[thumb_tip].y > lm_list[thumb_tip-1].y > lm_list[thumb_tip-2].y:
                    print("no me gusto")   
                    cv2.putText(img ,"dedicate a otra cosa", (20,30), cv2.FONT_HERSHEY_SIMPLEX, 1, (0,0,255), 3)
